"""
LDA Hyperparameter Optimization using GA, ES, and PABBO - NO EARLY STOPPING.

This is a modified version of run.py specifically for parallel execution.
It disables early stopping and ensures all algorithms run for exactly the specified
...
def run_single_optimizer(
    ...
    **optimizer_kwargs
    ...
    logger.info("=" * 80)
    logger.info(f"{algorithm_name} Optimization Starting (NO EARLY STOPPING)")
    logger.info("=" * 80)
...
def main():
    ...
    logger.info("=" * 80)
    logger.info("LDA Hyperparameter Optimization (NO EARLY STOPPING)")
    logger.info("=" * 80)
    ...
    # Run algorithms - WITH DISABLED EARLY STOPPING
    results = []

    if 'GA' in args.algorithms:
        logger.info("\n" + "=" * 80)
        logger.info("Running Genetic Algorithm (GA) - NO EARLY STOPPING")
        logger.info("=" * 80)
    ...
    if 'ES' in args.algorithms:
        logger.info("\n" + "=" * 80)
        logger.info("Running Evolution Strategy (ES) - NO EARLY STOPPING")
        logger.info("=" * 80)
    ...
    if 'PABBO' in args.algorithms or 'PABBO_Simple' in args.algorithms:
        logger.info("\n" + "=" * 80)
        logger.info("Running PABBO Simple - NO EARLY STOPPING")
        logger.info("=" * 80)
    ...
    if 'PABBO_Full' in args.algorithms:
        logger.info("\n" + "=" * 80)
        logger.info("Running PABBO Full (with Transformer) - NO EARLY STOPPING")
        logger.info("=" * 80)
